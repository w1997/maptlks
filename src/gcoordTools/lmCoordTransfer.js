...
export var lm_CoordTransferd = {
  ...
  lmCoordTransf: function (x_put, y_put, transfType, project) {
    ...
    //龙山
    else if (project === "longshan") {

      return this.lmLongShanTransferd(x_put, y_put, transfType);
    }
    //特定项目坐标系转换
  ...
  //龙山供排水
  lmLongShanTransferd: function (x_put, y_put, transfType) {
    ...
    if (transfType) {
      let coord = proj4(proj4('EPSG:4326'), proj4('EPSG:4545'), [x_put, y_put]);
      return coord;
    } else {
      let coord = proj4(proj4('EPSG:4545'), proj4('EPSG:4326'), [x_put, y_put]);
      return coord;
    }
  },
...
export var ProjectionTransform = {
  crs: {
