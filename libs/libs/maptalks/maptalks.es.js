  ...
  ! function(t) {
    ...
    e.prototype = {
      ...
      then: function then(t, i) {
        ...
        if (this.state === r) this.c ? this.c.push(s) : this.c = [s];
        else {
          var l = this.state,
            a = this.v;
          f(function() {
...
var GeometryEditor = function(_Eventable) {
  ...
  _proto.createCircleEditor = function createCircleEditor() {
    ...
    this._createResizeHandles(null, function(handleViewPoint) {
      ...
      var wline = new LineString([
        [center.x, center.y],
        [mouseCoordinate.x, center.y]
      ]);
      var hline = new LineString([
        [center.x, center.y],
        [center.x, mouseCoordinate.y]
      ]);
  ...
  _proto.createEllipseOrRectEditor = function createEllipseOrRectEditor() {
    ...
    var resizeHandles = this._createResizeHandles(null, function(mouseViewPoint, i) {
      ...
      if (isRect) {
        ...
        var wline = new LineString([
          [mirrorCoordinate.x, mirrorCoordinate.y],
          [mouseCoordinate.x, mirrorCoordinate.y]
        ]);
        var hline = new LineString([
          [mirrorCoordinate.x, mirrorCoordinate.y],
          [mirrorCoordinate.x, mouseCoordinate.y]
        ]);
        ...
        var _wline = new LineString([
          [center.x, center.y],
          [_mouseCoordinate.x, center.y]
        ]);

        var _hline = new LineString([
          [center.x, center.y],
          [center.x, _mouseCoordinate.y]
        ]);
  ...
  _getRenderPoints: function _getRenderPoints(placement) {
    ...
    if (placement === 'point') {
      ...
      rotations = coords.length ? [
        [map._prjToPoint(coords[0], glZoom), map._prjToPoint(coords[1], glZoom)]
      ] : [];
      ...
      rotations = _l4 ? [
        [map._prjToPoint(_coords[previous], glZoom), map._prjToPoint(_coords[current], glZoom)]
      ] : [];
    } else {
