...
const HomePage = PageBuilder(() => {
  ...
  return (
    <main className="page-content">
      ...
      <div class="btn-left">
        <div class="btn-left-legend">
          <div id="LegendFactory" class="black">
            <img />
              <span>厂站</span>
            </div>
            <div id="LegendPump" class="black">
              <img />
                <span>泵站</span>
            </div>
              <div id="LegendMonitor" class="black">
                <img />
                  <span>监测点</span>
            </div>
                <div id="LegendBigValue" class="black">
                  <img />
                    <span>大口径阀门</span>
            </div>
                  <div id="LegendPatroler" class="black">
                    <img>
                      <span>人员</span>
            </div>
                    <div id="LegendCatMonitor" class="black">
                      <img />
                        <span>车辆</span>
            </div>
                      <div id="LegendAlarmPoint" class="black">
                        <img />
                          <span>报警点位</span>
            </div>
                      </div>
