...
import { BigValuePointLayer } from "../../../lmDevices/bigValue";
...
export default {
  ...
  loadbigValueLayer() {
    ...
    fetch("../../../data/value/value300.json").then((function (res) {
      return res.json();
    })).then(geoJson => {
      ...
      let bigValueLayer = new BigValuePointLayer([], false); //true:默认加载 ；false:默认不加载
